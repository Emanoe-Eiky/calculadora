...
describe('CalculadoraService', () => {
  ...
  it('deve garantir que 1 + 4 = 5',
    ...
    it('deve gerantir que 1 - 4 = -3',
      inject([CalculadoraService], (service: CalculadoraService) => {
        let sutracao = service.calcular(1, 4, CalculadoraService.SUBTRACAO);
      ...
      it('deve garantir que 1 * 4 = 4',
        inject([CalculadoraService], (service: CalculadoraService) => {
          let multiolicação = service.calcular(1, 4 CalculadoraService.MULTIPLICACAO);
